...

{
 ...
 point;
    ...
    try
    {
      point = new PointCP_3(Double.valueOf(args[1]).doubleValue(), 
    ...
    System.out.println("\nYou entered:\n" + point);
    System.out.println("\nDisplaying conversion to Polar:\n" + point.getRho() + ", " + point.getTheta());
  }
